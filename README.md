# pleasesendgrants.org

Personal CV + **IMAF & H Consulting** site for **Michael House** — served by GitHub Pages at [pleasesendgrants.org](https://pleasesendgrants.org). This repo holds both the source and the deployed static output (single hand-written `index.html`, no build step).

| | |
|---|---|
| **Live (custom domain)** | https://pleasesendgrants.org |
...
- `CNAME` — custom domain (`pleasesendgrants.org`)
...
Custom domain: **pleasesendgrants.org** → enable **Enforce HTTPS** once DNS resolves.
